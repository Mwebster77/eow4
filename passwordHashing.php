include('php/connection.php');
    ...
    if( isset( $POST["createUserBtn"])){
        ...
        $query = "INSERT INTO users (user_id, userName, userPassword) VALUES (NULL, 'Usersname500', 'thisisapassword')";
