        ...
        <div class="nav-wrapper blue-grey lighten-1 z-depth-0">
                ...
                <ul id="nav-mobile" class="right hide-on-med-and-down">
                    <li><div class="chip">
                        ...
                        echo $returnReanName; 
                        ?></div></li>
                    <li><a href="../logout.php"><div class="waves-effect waves-custom btn-flat blue-grey light-2 center-align grey-text text-lighten-5" id="logoutUser" >Log Out</div></a></li>
                </ul>
                ...
                ?>
                 <ul id="nav-mobile" class="right hide-on-med-and-down">
                     <li><a href="../static/header.php"></a></li>
                 </ul>
                <?php
                    }
                ?>
